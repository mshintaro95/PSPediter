...
public class Program5{
    public static void main(String[] args){
        ...
        LinkedListManager<Pair<Double, Double>> linkedList = CsvFileReader.readFile(fileName, column1, column2);//格納済みリンクリスト取得
        LinkedListNode<Pair<Double, Double>> current_node = linkedList.head;

        double[] integrals = Calculator.calcSimpsonIntegral(linkedList);//t分布関数の積分値を3組の自由度、積分範囲の上端に対して計算
